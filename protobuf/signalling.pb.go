...
type ClientToStation struct {
	...
	// Allow client to specify decoy port
	PhantomPort *uint32 `protobuf:"varint,25,opt,name=phantom_port,json=phantomPort" json:"phantom_port,omitempty"`
	// Random-sized junk to defeat packet size fingerprinting.
	Padding              []byte   `protobuf:"bytes,100,opt,name=padding" json:"padding,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
...
func (m *ClientToStation) GetPhantomPort() uint32 {
	if m != nil && m.PhantomPort != nil {
		return *m.PhantomPort
	}
	return 0
}
...
type StationToDetector struct {
	...
	PhantomPort          *uint32  `protobuf:"varint,4,opt,name=phantom_port,json=phantomPort" json:"phantom_port,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *StationToDetector) GetPhantomPort() uint32 {
	if m != nil && m.PhantomPort != nil {
		return *m.PhantomPort
	}
	return 0
...
var fileDescriptor_39f66308029891ad = []byte{
	...
	,
}
